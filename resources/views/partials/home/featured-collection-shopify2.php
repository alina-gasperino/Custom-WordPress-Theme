...
<section class="section-text featured_collection_sec background-2">
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <div class="section2-text">
          <div class="collection_main_title">
            <p><?php echo get_field('featured_collection_heading2');?></p>
          </div>
        </div>
        <div class="featured_collection_slider">
          <?php $featured_collection_shopify2 = get_field('featured_collection_shopify2');
          
          ?>

         
         <?php echo do_shortcode('[wps_products
          collection="OUR QUENCHED SKIN SUMMER FAVORITES" images_sizing_toggle="true"
