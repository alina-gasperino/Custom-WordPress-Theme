      ...
      <div class="col-sm-12">
        <div class="section2-text">
          <div class="collection_main_title">
            <p><?php echo get_field('featured_collection_heading3');?></p>
          </div>
        </div>
        <div class="featured_collection_slider">
            <?php $featured_collection_shopify3 =  get_field('featured_collection_shopify3'); ?>
            <?php echo do_shortcode('[wps_products collection="OUR ETHEREAL SKIN FAVORITES" images_sizing_toggle="true"
