...
<?php if( get_field('show_advert_3') == 'yes' ) { ?>
    ...
    <div class="row">
            ...
            <div class="col-md-6 order-md-1">
              <div class="slider-banner-image">
                <img src="<?php echo get_field('product_image_adv3');?>" width="100%" alt="Shop Now Hero Image">
              ...
              <div class="banner-section-3">
                <div class="mb-5">
                  ...
                  <div class="sub-heading">
                    ...
                    <h2><?php echo get_field('advertise3_main_heading');?></h2>
                    <p><?php echo get_field('advertise3_description');?></p>
                  </div>
                  <!-- <div class="heading heading-h2">
                    ...
                    <div class="shop-button">
                      <button class="shop-now">
                        <a href="<?php echo get_field('advertise3_btn_url');?>"><?php echo get_field('advertise3_btn_text');?></a>
                        </button>
                    </div>
                     ...
                     <div class="marquee-text">
                      <div class="marquee_text">
                          ...
                          <?php $rotation_no = get_field('marquee_rotation_adv3'); ?>
                          <?php 
                          // $rotation_no = 40
                          for ($i=0; $i < $rotation_no; $i++) { 
                            
                          echo "<em>".get_field('marquee_title_adv3')."</em>";?> 
                          ...
                          <?php echo "<span class='marquee-text-inner'>".get_field('marquee_title_adv3') ."</span>" ; ?> 
                          <span class="dot-icon">.</span>
                          <!-- <svg xmlns="http://www.w3.org/2000/svg" width="55" height="55" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16"> <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/> </svg> -->
                          <?php  # code...
                          } ?>
